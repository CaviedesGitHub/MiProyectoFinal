...
from gateway.vistas.vistas import VistaPing, VistaEmpresa, VistaEmpresas, VistaProyectos, VistaProyecto, VistaPerfiles
...
settings_module = os.getenv('APP_SETTINGS_MODULE','gateway.config.ProductionConfig')
